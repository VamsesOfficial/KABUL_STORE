...
handler.all = async function (m) {
	...
	try {
        ...
        global.fvn = {
            ...
            message: { "liveLocationMessage": { "caption":"by : ᴠᴀᴍꜱᴇꜱ","h": `${wm}`, 'jpegThumbnail': fs.readFileSync('./thumbnail.jpg')}}
           }
            ...
            participant: `0@s.whatsapp.net`, ...(m.chat ? 
            { remoteJid: "status@broadcast" } : {}) },
            message: { "liveLocationMessage": { "title": "ᴠᴀᴍꜱᴇꜱ","h": wm, 'jpegThumbnail': fs.readFileSync('./thumbnail.jpg')}}
           }
